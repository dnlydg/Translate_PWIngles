...
<body>
    ...
    <section class="grid">
        <div class="card">
            <div class="card-body">
                ...
                <a href="#" onClick="openModal()" style="margin-left:1rem;" id="alterar-termo">Alterar Termo</a>
    ...
    <div id="alter-modal" class="modal" id="modalAlterar">
        <div class="modal-content">
            ...
            <form method="POST" action="../alterar-termo.php" class="modal-form">
                <input type="hidden" name="txtPegarID" id="txtPegarID" value="<?php echo @$_GET['idTermo']; ?>">
                <label for="txtNome">Nome</label>
                <input type="text" name="txtNome" id="txtNome" placeholder="Primeiro selecione um termo" value="<?php echo @$_GET['nomeTermo']; ?>">
                <label for="txtDesc">Descrição</label>
                <textarea name="txtDesc" id="txtDesc" cols="30" rows="4"><?php echo @$_GET['descTermo']; ?></textarea>
                <button type="submit" value="AlterarTermo" id="alterar" name="alterar">Validar</button>
            </form>
